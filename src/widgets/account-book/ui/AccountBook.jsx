    ...
    return (
        <div className="account-tariff-modal" role="dialog" aria-modal="true">
            <div className="account-tariff-modal__panel">
                ...
                <h2>Сменить тариф</h2>
                <p>
                    На период развития проекта тарифы доступны бесплатно на 3, возможно 4 месяца.
                    После этого один тариф останется бесплатным, другие будут пакетными и платными. По всем вопросам обращайтесь
                    к администрации.
                </p>
