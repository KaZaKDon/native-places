...
Endpoint восстанавливает маршрут текущего пользователя в активное состояние.
...
Пользователь может восстановить только свой маршрут.
...
| `422` | `Маршрут уже активен` | Маршрут уже имеет статус `active`. |
| `500` | `Не удалось восстановить маршрут` | Неожиданная ошибка backend-а или базы данных. |

## Frontend notes

- Использовать для кнопки «Восстановить» в архиве маршрутов.
- После успеха можно убрать маршрут из архива и вернуть в активный список.
- Если маршрут уже активен, backend вернёт `422`.
